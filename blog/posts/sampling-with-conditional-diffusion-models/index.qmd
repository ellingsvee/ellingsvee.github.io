...
$\mathbf{s}_{\boldsymbol{\theta}}(\mathbf{x}_t,t)$, but the measurement-alignment term is generally intractable because it requires marginalizing over the unknown clean sample $\mathbf{x}_0$. Training-free guidance methods therefore rely on approximating
